//! Vendored from `egui_flex` 0.6.0 — flexbox-style layout for egui.
...
//!
//! Re-exposed through `crate::flex` (a thin frostcore wrapper) so
//! every layout we ship can use the flex container without an extra
//! dep.
...
impl FlexContainerUi {
    ...
    pub fn content_widget(
        ...
        // egui ≥ 0.33 made `intrinsic_size` a field instead of a
        // method — match the local egui version.
